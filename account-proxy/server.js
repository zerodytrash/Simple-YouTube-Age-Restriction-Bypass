...
app.get("/getPlayer", (req, res) => {
    ...
    innertube.getPlayer(req.query.videoId, req.query.clientVersion, process.env.API_KEY, process.env.SAPISID, process.env.PSID, process.env.PROXY).then(videoInfoResponse => {
