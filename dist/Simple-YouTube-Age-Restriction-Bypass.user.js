...
(function iife(inject) {
  ...
  function unlockResponse$1(playerResponse) {var _playerResponse$video, _playerResponse$playa, _playerResponse$previ, _unlockedPlayerRespon, _unlockedPlayerRespon3;
  ...
  function handleXhrOpen(method, url, xhr) {
    ...
    if (url.pathname.indexOf('/youtubei/') === 0) {
      ...
      attach$4(xhr, 'setRequestHeader', (_ref2) => {let [headerName, headerValue] = _ref2;
